...
output_dir = "output_plots_diffusion_utr_0.5_top5"
...
def generate_sequences_in_batches(diffusion_model, oracle_model, total_samples, batch_size, guidance_scale=0.0):
    ...
    print(f"Generating {total_samples} samples (Guidance: {guidance_scale})...")
    for i in range(num_batches):
        ...
        batch_seqs = guided_sampling(diffusion_model, oracle_model, batch_size=current_batch_size,
...
_ = generate_sequences_in_batches(diffusion, real_oracle, 10, 16, 0.0)
_ = generate_sequences_in_batches(diffusion, real_oracle, 10, 16, 0.5)
